...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Overdue - Personal Production and Client Monitoring System for Financial Advisors</title>
                            ...
                            <div class="card-body">
                                ...
                                <table class="data-table data-table-feature payment-table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (strtotime("now") > strtotime($value->premium_due_date)): ?>
                                            <tr>
