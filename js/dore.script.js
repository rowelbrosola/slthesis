$.fn.addCommas = function(e) {
    ...
    function(e) {
        ...
        var o, i = !1;
        ! function() {
            $e = $e || {}, n.settings = $.extend({}, a, $e), "undefined" != typeof Storage && (localStorage.getItem("dore-direction") && (o = localStorage.getItem("dore-direction")), i = "rtl" == o && !0);
            ...
            function v() {
                ...
                $(".chat-app .scroll").length > 0 && be && ($(".chat-app .scroll").scrollTop($(".chat-app .scroll").prop("scrollHeight")), be.update()), e < y ? $("#app-container").addClass("menu-mobile") : e < C ? ($("#app-container").removeClass("menu-mobile"), $("#app-container").hasClass("menu-default") && ($("#app-container").removeClass(B), $("#app-container").addClass("menu-default menu-sub-hidden"))) : ($("#app-container").removeClass("menu-mobile"), $("#app-container").hasClass("menu-default") && $("#app-container").hasClass("menu-sub-hidden") && $("#app-container").removeClass("menu-sub-hidden")), W(0, !0)
            }
            ...
            $(window).on("resize", function(e) {
                e.originalEvent.isTrusted && v()
            }), v(), $(".search .search-icon").on("click", function() {
                ...
                13 == e.which && k(), 27 == e.which && x()
            }), $(document).on("click", function(e) {
                $(e.target).parents().hasClass("search") || x()
            }), $(".list").shiftSelectable();
            var S = 0,
                B = "menu-default menu-hidden sub-hidden main-hidden menu-sub-hidden main-show-temporary sub-show-temporary menu-mobile";
            ...
            function W(e, t, a) {
                ...
                if (0 != n.length) {
                    a = a || T();
                    if (0 == $(".sub-menu ul[data-link='" + a + "']").length && (2 == S || t) && $(window).outerWidth() >= y && A("menu-default")) return t ? ($("#app-container").removeClass(B), $("#app-container").addClass("menu-default menu-sub-hidden sub-hidden"), S = 1) : ($("#app-container").removeClass(B), $("#app-container").addClass("menu-default main-hidden menu-sub-hidden sub-hidden"), S = 0), void D();
                    if (0 == $(".sub-menu ul[data-link='" + a + "']").length && (1 == S || t) && $(window).outerWidth() >= y && A("menu-sub-hidden")) return t ? ($("#app-container").removeClass(B), $("#app-container").addClass("menu-sub-hidden sub-hidden"), S = 0) : ($("#app-container").removeClass(B), $("#app-container").addClass("menu-sub-hidden main-hidden sub-hidden"), S = -1), void D();
                    if (0 == $(".sub-menu ul[data-link='" + a + "']").length && (1 == S || t) && $(window).outerWidth() >= y && A("menu-hidden")) return t ? ($("#app-container").removeClass(B), $("#app-container").addClass("menu-hidden main-hidden sub-hidden"), S = 0) : ($("#app-container").removeClass(B), $("#app-container").addClass("menu-hidden main-show-temporary"), S = 3), void D();
                    e % 4 == 0 ? (A("menu-main-hidden") ? nextClasses = "menu-main-hidden" : A("menu-default") && A("menu-sub-hidden") ? nextClasses = "menu-default menu-sub-hidden" : A("menu-default") ? nextClasses = "menu-default" : A("menu-sub-hidden") ? nextClasses = "menu-sub-hidden" : A("menu-hidden") && (nextClasses = "menu-hidden"), S = 0) : e % 4 == 1 ? A("menu-default") && A("menu-sub-hidden") ? nextClasses = "menu-default menu-sub-hidden main-hidden sub-hidden" : A("menu-default") ? nextClasses = "menu-default sub-hidden" : A("menu-main-hidden") ? nextClasses = "menu-main-hidden menu-hidden" : A("menu-sub-hidden") ? nextClasses = "menu-sub-hidden main-hidden sub-hidden" : A("menu-hidden") && (nextClasses = "menu-hidden main-show-temporary") : e % 4 == 2 ? A("menu-main-hidden") && A("menu-hidden") ? nextClasses = "menu-main-hidden" : A("menu-default") && A("menu-sub-hidden") ? nextClasses = "menu-default menu-sub-hidden sub-hidden" : A("menu-default") ? nextClasses = "menu-default main-hidden sub-hidden" : A("menu-sub-hidden") ? nextClasses = "menu-sub-hidden sub-hidden" : A("menu-hidden") && (nextClasses = "menu-hidden main-show-temporary sub-show-temporary") : e % 4 == 3 && (A("menu-main-hidden") ? nextClasses = "menu-main-hidden menu-hidden" : A("menu-default") && A("menu-sub-hidden") ? nextClasses = "menu-default menu-sub-hidden sub-show-temporary" : A("menu-default") ? nextClasses = "menu-default sub-hidden" : A("menu-sub-hidden") ? nextClasses = "menu-sub-hidden sub-show-temporary" : A("menu-hidden") && (nextClasses = "menu-hidden main-show-temporary")), A("menu-mobile") && (nextClasses += " menu-mobile"), n.removeClass(B), n.addClass(nextClasses), D()
                }
            }
            ...
            $(".menu-button").on("click", function(e) {
                ...
                if (0 != $(".sub-menu ul[data-link='" + t + "']").length) {
                    z($(this).attr("href"));
                    $("#app-container");
                    return $("#app-container").hasClass("menu-mobile") ? $("#app-container").addClass("sub-show-temporary") : !$("#app-container").hasClass("menu-sub-hidden") || 2 != S && 0 != S ? !$("#app-container").hasClass("menu-hidden") || 1 != S && 3 != S ? !$("#app-container").hasClass("menu-default") || $("#app-container").hasClass("menu-sub-hidden") || 1 != S && 3 != S || W(0, !1, t) : W(2, !1, t) : W(3, !1, t), !1
                }
                ...
                if (!($(e.target).parents().hasClass("menu-button") || $(e.target).hasClass("menu-button") || $(e.target).parents().hasClass("sidebar") || $(e.target).hasClass("sidebar"))) {
                    ...
                    if ($("#app-container").hasClass("menu-sub-hidden") && 3 == S) W(T() == E ? 2 : 0);
                    else $("#app-container").hasClass("menu-main-hidden") && $("#app-container").hasClass("menu-mobile") ? W(0) : ($("#app-container").hasClass("menu-hidden") || $("#app-container").hasClass("menu-mobile")) && W(0)
                }
            });
            var E = "";
            ...
            function z(e) {
                if (0 != $(".main-menu").length) {
                    ...
                    if (0 == $(".sub-menu ul[data-link='" + t + "']").length) {
                        ...
                        return S = A("menu-sub-hidden") || A("menu-hidden") ? 0 : 1, $("#app-container").addClass("sub-hidden"), $(".sub-menu").addClass("no-transition"), $("main").addClass("no-transition"), void setTimeout(function() {
                            $(".sub-menu").removeClass("no-transition"), $("main").removeClass("no-transition")
                        }, 350)
                    }
                    t != E && ($(".sub-menu ul").fadeOut(0), $(".sub-menu ul[data-link='" + t + "']").slideDown(100), $(".sub-menu .scroll").scrollTop(0), E = t)
                }
            }
            ...
            if (z($(".main-menu ul li.active a").attr("href")), $(".app-menu-button").on("click", function(e) {
                ...
                if (document.getElementById("visitChartFull")) {
                    var R = document.getElementById("visitChartFull").getContext("2d");
                    new Chart(R, {
                        type: "LineWithShadow",
                        data: {
                ...
                if (document.getElementById("conversionChart")) {
                    var F = document.getElementById("conversionChart").getContext("2d");
                    new Chart(F, {
                        type: "LineWithShadow",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("smallChart1")) {
                    var V = document.getElementById("smallChart1").getContext("2d");
                    new Chart(V, {
                        type: "LineWithLine",
                        plugins: [H],
                        data: {
                ...
                if (document.getElementById("smallChart2")) {
                    var _ = document.getElementById("smallChart2").getContext("2d");
                    new Chart(_, {
                        type: "LineWithLine",
                        plugins: [H],
                        data: {
                ...
                if (document.getElementById("smallChart3")) {
                    var N = document.getElementById("smallChart3").getContext("2d");
                    new Chart(N, {
                        type: "LineWithLine",
                        plugins: [H],
                        data: {
                ...
                if (document.getElementById("smallChart4")) {
                    var q = document.getElementById("smallChart4").getContext("2d");
                    new Chart(q, {
                        type: "LineWithLine",
                        plugins: [H],
                        data: {
                ...
                if (document.getElementById("areaChart")) {
                    var U = document.getElementById("areaChart").getContext("2d");
                    new Chart(U, {
                        type: "LineWithShadow",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("scatterChart")) {
                    var X = document.getElementById("scatterChart").getContext("2d");
                    new Chart(X, {
                ...
                if (document.getElementById("scatterChartNoShadow")) {
                    var Y = document.getElementById("scatterChartNoShadow").getContext("2d");
                    new Chart(Y, {
                        type: "scatter",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("radarChartNoShadow")) {
                    var G = document.getElementById("radarChartNoShadow").getContext("2d");
                    new Chart(G, {
                        type: "radar",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("polarChart")) {
                    var j = document.getElementById("polarChart").getContext("2d");
                    new Chart(j, {
                ...
                if (document.getElementById("polarChartNoShadow")) {
                    var Q = document.getElementById("polarChartNoShadow").getContext("2d");
                    new Chart(Q, {
                        type: "polarArea",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("productChart")) {
                    var ee = document.getElementById("productChart").getContext("2d");
                    new Chart(ee, {
                        type: "BarWithShadow",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("productChartNoShadow")) {
                    var te = document.getElementById("productChartNoShadow").getContext("2d");
                    new Chart(te, {
                        type: "bar",
                        options: {
                            plugins: {
                ...
                if (document.getElementById("contributionChart1")) new Chart(document.getElementById("contributionChart1").getContext("2d"), ae);
                if (document.getElementById("contributionChart2")) new Chart(document.getElementById("contributionChart2").getContext("2d"), ae);
                if (document.getElementById("contributionChart3")) new Chart(document.getElementById("contributionChart3").getContext("2d"), ae);
                var ne = {
                ...
                if (document.getElementById("categoryChart")) {
                    var oe = document.getElementById("categoryChart");
                    new Chart(oe, {
                        plugins: [ne],
                ...
                if (document.getElementById("categoryChartNoShadow")) {
                    var ie = document.getElementById("categoryChartNoShadow");
                    new Chart(ie, {
                        plugins: [ne],
                        type: "doughnut",
                        data: {
                ...
                if (document.getElementById("pieChartNoShadow")) {
                    var re = document.getElementById("pieChartNoShadow");
                    new Chart(re, {
                        type: "pie",
                        data: {
                            labels: ["Cakes", "Cupcakes", "Desserts"],
                ...
                if (document.getElementById("pieChart")) re = document.getElementById("pieChart"), new Chart(re, {
                    type: "PieWithShadow",
                    data: {
                        labels: ["Cakes", "Cupcakes", "Desserts"],
                        datasets: [{
                ...
                if (document.getElementById("frequencyChart")) {
                    var se = document.getElementById("frequencyChart");
                    new Chart(se, {
                        plugins: [ne],
                        type: "DoughnutWithShadow",
                        data: {
                ...
                if (document.getElementById("ageChart")) {
                    var le = document.getElementById("ageChart");
                    new Chart(le, {
                        plugins: [ne],
                        type: "DoughnutWithShadow",
                        data: {
                ...
                if (document.getElementById("genderChart")) {
                    var de = document.getElementById("genderChart");
                    new Chart(de, {
                        plugins: [ne],
                        type: "DoughnutWithShadow",
                        data: {
                ...
                if (document.getElementById("workChart")) {
                    var ce = document.getElementById("workChart");
                    new Chart(ce, {
                        plugins: [ne],
                        type: "DoughnutWithShadow",
                        data: {
                ...
                if (document.getElementById("codingChart")) {
                    var pe = document.getElementById("codingChart");
                    new Chart(pe, {
                        plugins: [ne],
                        type: "DoughnutWithShadow",
                        data: {
            ...
            if ($().fullCalendar) {
                var ue = new Date((new Date).setHours((new Date).getHours()));
                ue.getDate(), ue.getMonth();
            ...
            if ($().DataTable) {
                ...
                var he = $("#datatableRows").DataTable({
                    bLengthChange: !1,
                    destroy: !0,
                    info: !1,
                    sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-right"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
                    ...
                    drawCallback: function() {
                        me(), $("#checkAllDataTables").prop("checked", !1), $("#checkAllDataTables").prop("indeterminate", !1).trigger("change"), $($(".dataTables_wrapper .pagination li:first-of-type")).find("a").addClass("prev"), $($(".dataTables_wrapper .pagination li:last-of-type")).find("a").addClass("next"), $(".dataTables_wrapper .pagination").addClass("pagination-sm");
                ...
                $("#datatableRows tbody").on("click", "tr", function() {
                    ...
                    $("#checkAllDataTables").prop("checked") ? ($("#datatableRows tbody tr").addClass("selected"), $("#datatableRows tbody tr .custom-checkbox input").prop("checked", !0).trigger("change")) : me()
                }), $("#searchDatatable").on("keyup", function(e) {
                    he.search($(this).val()).draw()
                }), $("#pageCountDatatable .dropdown-menu a").on("click", function(e) {
                    var t = $(this).text();
                    he.page.len(parseInt(t)).draw()
                });
                var ge = $("#addToDatatable").stateButton();
                $("#rightModal").on("shown.bs.modal", function(e) {
                    ...
                    if ($("#addToDatatableForm").valid()) {
                        ...
                        }), a.Check = '<label class="custom-control custom-checkbox mb-1 align-self-center data-table-rows-check"><input type="checkbox" class="custom-control-input"><span class="custom-control-label">&nbsp;</span></label>', he.row.add(a).draw(), setTimeout(function() {
                            ge.showSuccess(!0, "New row added!"), setTimeout(function() {
                                $("#rightModal").modal("toggle"), ge.reset(), t.each(function() {
                                    $(this).val("")
            ...
            var fe = document.getElementsByClassName("needs-validation");
            Array.prototype.filter.call(fe, function(e) {
            ...
            if (void 0 !== Ce) {
                ...
                var ye = document.querySelectorAll(".cropper-preview"),
                    $e = {
                        aspectRatio: 4 / 3,
                        preview: ".img-preview",
                        ready: function() {
                            var e = this.cloneNode();
                            e.className = "", e.style.cssText = "display: block;width: 100%;min-width: 0;min-height: 0;max-width: none;max-height: none;", we(ye, function(t) {
                ...
                if ($("#inputImage").length > 0) {
                    var ve, ke = $("#inputImage")[0],
                        xe = $("#cropperImage")[0];
                    ke.onchange = function() {
                        var e, t = this.files;
                        t && t.length && (e = t[0], $("#cropperContainer").css("display", "block"), /^image\/\w+/.test(e.type) ? (uploadedImageType = e.type, uploadedImageName = e.name, xe.src = uploadedImageURL = URL.createObjectURL(e), ve && ve.destroy(), ve = new Ce(xe, $e), ke.value = null) : window.alert("Please choose an image file."))
                    }
                }
            }
            "undefined" != typeof noUiSlider && ($("#dashboardPriceRange").length > 0 && noUiSlider.create($("#dashboardPriceRange")[0], {
                ...
                if ($(this).parents(".chat-app").length > 0) {
                    ...
                    function a() {
                        var a = 0;
                        $("main").length > 0 && (a += parseInt($("main").css("margin-top"))), $(".chat-input-container").length > 0 && (a += $(".chat-input-container").outerHeight(!0)), $(".chat-heading-container").length > 0 && (a += $(".chat-heading-container").outerHeight(!0)), $(".separator").length > 0 && (a += $(".separator").outerHeight(!0)), $(".chat-app .scroll").css("height", window.innerHeight - a + "px"), be && ($(".chat-app .scroll").scrollTop($(".chat-app .scroll").prop("scrollHeight")), be.update()), window.innerWidth < 576 ? (be && (be.destroy(), be = null), $(".chat-app .scroll-content > div:last-of-type").css("padding-bottom", $(".chat-input-container").outerHeight(!0) + "px"), t || (setTimeout(function() {
                            $("html, body").animate({
                                scrollTop: $(document).height() + 30
                            }, 100)
                        }, 300), t = !0)) : (be || ((be = new PerfectScrollbar(e, {
                            suppressScrollX: !0
            ...
            var Se = $("#successButton").stateButton();
            Se.on("click", function(e) {
                e.preventDefault(), Se.showSpinner(), setTimeout(function() {
                    Se.showSuccess(!0), setTimeout(function() {
                        Se.reset()
                    }, 2e3)
                }, 3e3)
            });
            var Be = $("#failButton").stateButton();
            ...
            if ($("#failButton").on("click", function(e) {
                    e.preventDefault(), Be.showSpinner(), setTimeout(function() {
                        Be.showFail(!0), setTimeout(function() {
                            Be.reset()
                        }, 2e3)
                    }, 3e3)
            ...
            if ("undefined" != typeof ClassicEditor && ClassicEditor.create(document.querySelector("#ckEditorClassic")).catch(function(e) {}), $("body > *").css({
                ...
                $("#smartWizardDefault").smartWizard({
                    ...
                    return !Ae($("#smartWizardValidation #form-step-1")) || (console.log("Form Done"), !1)
                })
            }
            if ("undefined" != typeof Countdown) {
                var Ee = new Date((new Date).setMinutes((new Date).getMinutes() + 5e3));
                new Countdown({
                    selector: "#timer",
                    leadingZeros: !0,
                    msgBefore: "",
            ...
            if ("undefined" != typeof baguetteBox && (baguetteBox.run(".gallery"), baguetteBox.run(".lightbox")), $().ellipsis && $(".ellipsis").ellipsis({
                ...
                if ($(".glide.details").length > 0) {
                    var ze = $(".glide.thumbs li").length,
                        De = Math.min(5, ze),
                        Ie = new Glide(".glide.details", {
                            bound: !0,
                            rewind: !1,
                            focusAt: 0,
                            perView: 1,
                        ...
                        Pe = new Glide(".glide.thumbs", {
                            ...
                            breakpoints: {
                                576: {
                                    perView: Math.min(4, ze)
                                },
                                420: {
                                    perView: Math.min(3, ze)
                                }
                            }
                        });

                    function Re(e) {
                        $(".glide.thumbs li").removeClass("active"), $($(".glide.thumbs li")[e]).addClass("active"), e >= Pe.index + De && Pe.go(">"), e < Pe.index && Pe.go("<")
                    }
                    $(".glide.thumbs").css("width", 70 * De), Re(0), $(".glide.thumbs li").on("click", function(e) {
                        var t = $(e.currentTarget).index();
                        Ie.go("=" + t), Re(t)
                    }), Ie.on(["swipe.end"], function() {
                        Re(Ie.index)
                    }), Pe.on("resize", function() {
                        De = Math.min(Pe.settings.perView, ze), $(".glide.thumbs").css("width", 70 * De), De >= $(".glide.thumbs li").length ? $(".glide.thumbs .glide__arrows").css("display", "none") : $(".glide.thumbs .glide__arrows").css("display", "block")
                    }), Pe.mount(), Ie.mount()
                }
                if ($(".glide.dashboard-numbers").length > 0 && new Glide(".glide.dashboard-numbers", {
                    ...
                    Fe.on(["swipe.move"], function() {
                        Le = !1
                    }), Fe.on(["run.after"], function() {
                        Le = !0
                    }), Fe.mount(), $(".glide.gallery").get(0).addEventListener("click", function(e) {
                        return !!Le || (e.stopPropagation(), e.preventDefault(), !1)
                    }, !0)
                }
            }
            fe = document.getElementsByClassName("needs-validation"), Array.prototype.filter.call(fe, function(e) {
                e.addEventListener("submit", function(t) {
